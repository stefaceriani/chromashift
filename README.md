...
| **Quick access** | 🎨 button in the top bar navigates directly to Settings |
...
1. Open Spotify **Settings** (or click 🎨 in the top bar)
2. Scroll to the **ChromaShift** section at the bottom
3. Pick a **preset** or click any color circle to open the picker
4. Colors update **live** as you drag the picker
5. Click **Save & Apply** to persist your changes
