...
(function ChromaShift() {
  ...
  const COLOR_DEFS = [
    { key: "csText",              label: "Testo principale",     group: "Testo" },
    { key: "csSubtext",           label: "Testo secondario",     group: "Testo" },
    { key: "csMain",              label: "Sfondo principale",    group: "Sfondi" },
    { key: "csMainElevated",      label: "Sfondo elevato",       group: "Sfondi" },
    { key: "csHighlight",         label: "Hover / selezione",    group: "Sfondi" },
    { key: "csHighlightElevated", label: "Hover elevato",        group: "Sfondi" },
    { key: "csAccent",            label: "Accento",              group: "Accenti" },
    { key: "csPlayButton",        label: "Tasto Play",           group: "Accenti" },
    { key: "csPlayButtonHover",   label: "Tasto Play (hover)",   group: "Accenti" },
    { key: "csButtonDisabled",    label: "Bottone disabilitato", group: "Accenti" },
    { key: "csSidebar",           label: "Sidebar",              group: "Struttura" },
    { key: "csPlayer",            label: "Player bar",           group: "Struttura" },
    { key: "csCard",              label: "Card",                 group: "Struttura" },
    { key: "csCardHover",         label: "Card hover",           group: "Struttura" },
    { key: "csNotification",      label: "Notifiche",            group: "Struttura" },
  ];
...
[class*="contentSpacing"]{background-color:${bg}!important}
...
[data-testid="progress-bar"] [class*="background"],
[data-testid="progress-bar"] [class*="Background"],
[class*="playbackProgressBar"] [class*="background"],
[class*="playbackProgressBar"] [class*="Background"]{
  background-color:${hl}!important;
  height:4px!important;border-radius:2px!important;
}
[data-testid="progress-bar"] [class*="foreground"],
[data-testid="progress-bar"] [class*="Foreground"],
[class*="playbackProgressBar"] [class*="foreground"],
[class*="playbackProgressBar"] [class*="Foreground"]{
  background-color:${acc}!important;
  height:4px!important;border-radius:2px!important;
  min-width:2px!important;
}
[data-testid="progress-bar"] [class*="handle"],
[data-testid="progress-bar"] [class*="Handle"],
[class*="playbackProgressBar"] [class*="handle"],
[class*="playbackProgressBar"] [class*="Handle"]{
  background-color:${acc}!important;
...
[data-testid="progress-bar"]:hover [class*="handle"],
[data-testid="progress-bar"]:hover [class*="Handle"]{
  opacity:1!important;
}

/* ── Volume bar: grigia a riposo, accent hover — dimensioni native ── */
[data-testid="volume-bar"] [class*="foreground"],
[data-testid="volume-bar"] [class*="Foreground"],
[class*="volumeBar"] [class*="foreground"],
[class*="volumeBar"] [class*="Foreground"],
[class*="volume"] [class*="Bar"] [class*="foreground"],
[class*="volume"] [class*="Bar"] [class*="Foreground"]{
  background-color:${sub}!important;
  transition:background-color .15s!important;
}
[data-testid="volume-bar"]:hover [class*="foreground"],
[data-testid="volume-bar"]:hover [class*="Foreground"],
[class*="volumeBar"]:hover [class*="foreground"],
[class*="volumeBar"]:hover [class*="Foreground"],
[class*="volume"]:hover [class*="Bar"] [class*="foreground"],
[class*="volume"]:hover [class*="Bar"] [class*="Foreground"]{
  background-color:${acc}!important;
}
[data-testid="volume-bar"] [class*="background"],
[data-testid="volume-bar"] [class*="Background"],
[class*="volumeBar"] [class*="background"],
[class*="volumeBar"] [class*="Background"],
[class*="volume"] [class*="Bar"] [class*="background"],
[class*="volume"] [class*="Bar"] [class*="Background"]{
  background-color:${hl}!important;
}
...
`;
  ...
  function runAllFixes() { fixTopBar(); fixPlayButtons(); fixFilterBar(); attachTopBarObserver(); }
...
<p class="cs4-subtitle">Personalizza ogni colore di Spotify in tempo reale</p>
<div class="cs4-tabs">
  <button class="cs4-tab cs4-active" data-panel="presets">Preset</button>
  <button class="cs4-tab" data-panel="editor">Editor colori</button>
</div>
<div class="cs4-panel cs4-active" id="cs4-panel-presets">
  <div class="cs4-presets-grid" id="cs4-grid"></div>
  <div class="cs4-save-row">
    <input class="cs4-name-input" id="cs4-pname" placeholder="Nome preset personalizzato…" maxlength="32">
    <button class="cs4-btn cs4-btn-primary" id="cs4-save-btn">＋ Salva corrente</button>
  </div>
</div>
<div class="cs4-panel" id="cs4-panel-editor">
  <div id="cs4-editor"></div>
  <div class="cs4-actions">
    <button class="cs4-btn cs4-btn-primary" id="cs4-apply">✓ Applica &amp; Salva</button>
    <button class="cs4-btn cs4-btn-secondary" id="cs4-reset">↺ Ripristina preset</button>
    <button class="cs4-btn cs4-btn-danger" id="cs4-default">↩ Default Spotify</button>
  </div>
</div>
`;
      ...
      groups.forEach(group => {
        ...
        COLOR_DEFS.filter(d => d.group === group).forEach(def => {
          ...
          row.innerHTML = `
            ...
            <div class="cs4-color-lbl">${def.label}</div>
    ...
    function openSlider(key, anchor) {
      ...
      const defLabel = COLOR_DEFS.find(d => d.key === key)?.label || key;
      pop.innerHTML = `
    ...
    document.getElementById("cs4-apply").addEventListener("click", () => {
      applyColors(editColors); saveColors(editColors); toast("Salvato e applicato!");
    });
    document.getElementById("cs4-reset").addEventListener("click", () => {
      ...
      toast("Ripristinato al preset attivo.");
    });
    document.getElementById("cs4-default").addEventListener("click", () => {
      ...
      setTimeout(() => { const s = document.getElementById(SECTION_ID); if (s) renderUI(s); }, 80);
      toast("Default Spotify ripristinato.");
    });
  }
