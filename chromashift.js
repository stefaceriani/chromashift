...
(function ChromaShift() {
  ...
  const COLOR_DEFS = [
    ...
    { key: "csProgressBg",        label: "Avanzamento sfondo",   group: "Player" },
    { key: "csProgressFg",        label: "Avanzamento colore",   group: "Player" },
    { key: "csVolumeBg",          label: "Volume sfondo",        group: "Player" },
    { key: "csVolumeFg",          label: "Volume colore",        group: "Player" },
  ];
